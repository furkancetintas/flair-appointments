...
export default function AdminEarnings() {
  ...
  return (
    <div className="space-y-6">
      <div><h2 className="text-2xl font-semibold mb-2">Kazançlar</h2><p className="text-sm sm:text-base text-muted-foreground">Günlük, haftalık ve aylık kazançlarınızı takip edin</p></div>
